...
public class Screensnake extends JPanel{
    ...
    public Screensnake(){// initializes snake in the middle of the board;
    ...
    public static void main(String[] args){
        ...
        p.add(bordCol);
        p.add(new Label("                                                                                         "));
        p.add(new Label("Use left and right arrow keys or A and D to move"));
        p.add(new Label("                                                                                         "));
        p.add(start);
        ...
        Screensnake ss = new Screensnake();
        ...
        jf.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent ke){
                switch(ke.getKeyCode()){
                    ...
                    case KeyEvent.VK_A:
                        ss.moveDirection = "LEFT";
                        break;
                    case KeyEvent.VK_RIGHT:
                    case KeyEvent.VK_D:
                        ss.moveDirection = "RIGHT";
                        break;       
                }
            }
        });
        ...
        jf.remove(ss);
        p = new JPanel();
        p.add(new Label(String.format("Your score is %d on %s", ss.score, dif), Label.CENTER));
        
        int[] highscores = highscores(ss.score, line);
        ...
        //JOptionPane.showMessageDialog(null, "Your score is " + ss.score);
